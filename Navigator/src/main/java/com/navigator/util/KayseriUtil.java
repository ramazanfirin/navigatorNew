...
List<KeyValueDTO> resultList = new ArrayList<KeyValueDTO>();
 String url = "http://cbs.kayseri.bel.tr/GenelSayfalar/AdresBilesenleri/KIlce.aspx";		
 String result = Util.getUrl(url);
		
 List<SelectItem> list = new ArrayList<SelectItem>();
	Document doc = Jsoup.parse(result);
	Element impress = doc.getElementById("ctl00_ContentPlaceHolder1_grdIlce");
